...
__global__ void
gesummv_kernel(__attribute__((annotate("4096,4096"))) DATA_TYPE *a,
               __attribute__((annotate("4096,4096"))) DATA_TYPE *b,
               __attribute__((annotate("4096"))) DATA_TYPE *x,
               __attribute__((annotate("4096"))) DATA_TYPE *y,
               __attribute__((annotate("4096"))) DATA_TYPE *tmp)
    __attribute__((annotate("16:256"))) {
