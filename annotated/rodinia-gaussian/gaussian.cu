 ...
 **-------------------------------------------------------
 */
__global__ void Fan1(__attribute__((annotate("1024:1024"))) float *m_cuda,
                     __attribute__((annotate("1024:1024"))) float *a_cuda,
                     __attribute__((annotate("1024"))) int Size,
                     __attribute__((annotate("0"))) int t)
    __attribute__((annotate("2:512"))) {
...
__global__ void Fan2(__attribute__((annotate("1024:1024"))) float *m_cuda,
                     __attribute__((annotate("1024:1024"))) float *a_cuda,
                     __attribute__((annotate("1024"))) float *b_cuda,
                     __attribute__((annotate("1024"))) int Size,
                     __attribute__((annotate("1024"))) int j1,
                     __attribute__((annotate("0"))) int t)
    __attribute__((annotate("256,256:4,4"))) {
  if (threadIdx.x + blockIdx.x * blockDim.x >= Size - 1 - t)
    return;
