...
__global__ void
needle_cuda_shared_1(__attribute__((annotate("8193:8193"))) int *referrence,
                     __attribute__((annotate("8193:8193"))) int *matrix_cuda,
                     __attribute__((annotate("8193"))) int cols,
                     __attribute__((annotate("10"))) int penalty,
                     __attribute__((annotate("0"))) int i,
                     __attribute__((annotate("512"))) int block_width)
    __attribute__((annotate("1:16"))) {
  int bx = blockIdx.x;
  int tx = threadIdx.x;
...
__global__ void
needle_cuda_shared_2(__attribute__((annotate("8193:8193"))) int *referrence,
                     __attribute__((annotate("8193:8193"))) int *matrix_cuda,
                     __attribute__((annotate("8193"))) int cols,
                     __attribute__((annotate("10"))) int penalty,
                     __attribute__((annotate("0"))) int i,
