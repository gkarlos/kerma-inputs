...
__global__ void
lud_diagonal(__attribute__((annotate("2048:2048"))) float *m,
             __attribute__((annotate("2048"))) int matrix_dim,
             __attribute__((annotate("0"))) int offset)
...
__global__ void
lud_perimeter(__attribute__((annotate("2048:2048"))) float *m,
              __attribute__((annotate("2048"))) int matrix_dim,
              __attribute__((annotate("0"))) int offset)
    __attribute__((annotate("127:256"))) {
...
__global__ void
lud_internal(__attribute__((annotate("2048:2048"))) float *m,
             __attribute__((annotate("2048"))) int matrix_dim,
             __attribute__((annotate("0"))) int offset)
    __attribute__((annotate("127,127:16,16"))) {
  __shared__ float peri_row[BLOCK_SIZE][BLOCK_SIZE];
  __shared__ float peri_col[BLOCK_SIZE][BLOCK_SIZE];
