...
__global__ void mm2_kernel1(__attribute__((annotate("2048,2048"))) DATA_TYPE *A,
                            __attribute__((annotate("2048,2048"))) DATA_TYPE *B,
                            __attribute__((annotate("2048,2048"))) DATA_TYPE *C)
    __attribute__((annotate("64,64:8,32"))) {
...
__global__ void mm2_kernel2(__attribute__((annotate("2048,2048"))) DATA_TYPE *C,
                            __attribute__((annotate("2048,2048"))) DATA_TYPE *D,
                            __attribute__((annotate("2048,2048"))) DATA_TYPE *E)
    __attribute__((annotate("64,64:8,32"))) {
  int j = blockIdx.x * blockDim.x + threadIdx.x;
  int i = blockIdx.y * blockDim.y + threadIdx.y;
